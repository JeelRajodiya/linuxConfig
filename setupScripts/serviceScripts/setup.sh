...
# 
# How it works:
# - All executables in ./executables/ are copied to /usr/local/bin/
# - Services in ./all/system/ → installed as SYSTEM services (run as root)
# - Services in ./all/user/   → installed as USER services (run in your session)
#
...
EXEC_DIR="$SCRIPT_DIR/executables"
BIN_DEST="/usr/local/bin"

SYSTEM_SERVICE_DIR="$SCRIPT_DIR/all/system"
SYSTEM_DEST="/etc/systemd/system"

USER_SERVICE_DIR="$SCRIPT_DIR/all/user"
